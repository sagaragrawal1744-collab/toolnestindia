...
_Generated: 2026-07-07T06:46:28.595Z_
...
Workspace `mcp.json` _(folder: ToolNest India)_

- **c:\Users\acer\Desktop\ToolNest India\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\acer\.claude.json** — _File exists — no servers defined_
